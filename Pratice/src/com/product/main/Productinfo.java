...
import com.arwizon.impl.Productimp;
		...
		while (true) {
			...
			case 1:
				...
				//	Productin obj = new Productimp();
					...
					Product pr = obj.addProduct(name,cost1,discount,quantity1,url);
					 //arr[i]=pr;
					l.add(pr);
					}
			...
			List<Product> n= obj.searchProduct(name,l);
				if (n.size()==0) {				
			...
			//	String name1 =sc.next();
				...
				obj.updateProduct(name1, cost1,l);
